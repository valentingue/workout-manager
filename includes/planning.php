...
namespace workout_manager\Entities;
...
class Planning extends Entity {
	...
	public function render_metabox_workout($post) {
    	include WORKOUT_MANAGER_DIR.'includes/templates/planning/metabox-workout.php';
	}

	public function render_metabox_preview($post) {
		include WORKOUT_MANAGER_DIR.'includes/templates/planning/metabox-preview.php';
	}

	public function render_metabox_settings($post) {
		include WORKOUT_MANAGER_DIR.'includes/templates/planning/metabox-settings.php';
	}

	public function render_metabox_shortcode($post) {
		$post_id = $post->ID;
		include WORKOUT_MANAGER_DIR.'includes/templates/planning/metabox-shortcode.php';
	}

	public function render_metabox_workout_styling($post) {
		include WORKOUT_MANAGER_DIR.'includes/templates/planning/metabox-workout-styling.php';
	}

	public function render_metabox_planning_styling($post) {
		include WORKOUT_MANAGER_DIR.'includes/templates/planning/metabox-planning-styling.php';
	}
	...
	public function add_custom_column_content($column, $post_id) {
		switch ($column) {
		case 'shortcode':
			include WORKOUT_MANAGER_DIR.'includes/templates/planning/column-shortcode.php';
			break;
		}
	}
